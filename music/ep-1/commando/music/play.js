        ...
        const play = async (song) => {
          ...
          if (!song) {
            setTimeout(function () {
              ...
              sendError("Leaving the voice channel because I think there are no songs in the queue. [GitHub](https://github.com/ThatGuyJamal/DeepWebAPI-Git-host)", message.channel)
            }, STAY_TIME * 1000);
